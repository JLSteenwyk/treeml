...
class PhyloGradientBoostingClassifier(PhyloBaseEstimator):
    """Gradient Boosting classifier with phylogenetic correction."""
    ...
    def fit(self, X, y, tree=None, species_names=None):
        ...
        self.inner_model_ = GradientBoostingClassifier(
